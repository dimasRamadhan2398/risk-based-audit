...
func (s *Seeder) SeedEmployees() error {
	...
	employees := []models.Employee{
		...
		},
		{
			...
			LevelGrade:        8,
			WorkLocationID:    &hqLocation.ID,
			ResidenceAddress:  "Jl. Jendral Sudirman Kav. 52-53, Jakarta",
			ResidenceCity:     "Jakarta",
			ResidenceProvince: "DKI Jakarta",
			ResidencePostal:   "12190",
			IsActive:          true,
			JoinDate:          joinDate,
		},
		{
			...
			LevelGrade:        5,
			WorkLocationID:    &hqLocation.ID,
			ResidenceAddress:  "Jl. HR Rasuna Said Blok X-5, Jakarta",
			ResidenceCity:     "Jakarta",
			ResidenceProvince: "DKI Jakarta",
			ResidencePostal:   "12950",
			IsActive:          true,
			JoinDate:          joinDate,
		},
		{
			...
			LevelGrade:        7,
			WorkLocationID:    &hqLocation.ID,
			ResidenceAddress:  "Jl. MH Thamrin No. 28-30, Jakarta",
			ResidenceCity:     "Jakarta",
			ResidenceProvince: "DKI Jakarta",
			ResidencePostal:   "10350",
			IsActive:          true,
		...
		},
		{
			...
			LevelGrade:        4,
			WorkLocationID:    &hqLocation.ID,
			ResidenceAddress:  "Jl. Gatot Subroto No. 40, Jakarta",
			ResidenceCity:     "Jakarta",
			ResidenceProvince: "DKI Jakarta",
			ResidencePostal:   "12930",
			IsActive:          true,
			JoinDate:          joinDate,
		},
		{
			...
			LevelGrade:        8,
			WorkLocationID:    &hqLocation.ID,
			ResidenceAddress:  "Jl. Asia Afrika No. 8, Jakarta",
			ResidenceCity:     "Jakarta",
			ResidenceProvince: "DKI Jakarta",
			ResidencePostal:   "10270",
			IsActive:          true,
			JoinDate:          joinDate,
		},
		{
			...
			LevelGrade:        6,
			WorkLocationID:    &hqLocation.ID,
			ResidenceAddress:  "Jl. Senopati No. 12, Jakarta",
			ResidenceCity:     "Jakarta",
			ResidenceProvince: "DKI Jakarta",
			ResidencePostal:   "12110",
			IsActive:          true,
			JoinDate:          joinDate,
		},
	}
