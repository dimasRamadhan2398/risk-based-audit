...
func NewCompanyRepository(db *gorm.DB) ICompanyRepository { return &CompanyRepository{BaseRepository: repositories.NewBaseRepository(db)} }
func (r *CompanyRepository) Create(company *models.Company) error { return r.BaseRepository.Create(company) }
func (r *CompanyRepository) Update(company *models.Company) error { return r.BaseRepository.Update(company) }
func (r *CompanyRepository) Delete(id uuid.UUID) error { return r.BaseRepository.Delete(&models.Company{ID: id}) }
...
func (r *CompanyRepository) FindAll() ([]*models.Company, error) {
	...
	if err := r.GetDB().Find(&companies).Error; err != nil { return nil, err }
