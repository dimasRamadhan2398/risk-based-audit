  ...
  <div class="p-6 max-w-7xl mx-auto space-y-6 min-h-screen">
    ...
    <div class="flex items-center gap-4 mb-6">
      ...
      <div>
        ...
        <p class="text-sm text-gray-500">Upload external Periodic Self Assessment (RSA) documents</p>
      </div>
    </div>
        ...
        <UCard :ui="{ body: 'p-6' }" class="shadow-sm border border-gray-200">
          <template #header>
            <h3 class="text-lg font-bold text-gray-900 flex items-center gap-2">
              ...
              Upload Periodic Self Assessment Document
            </h3>
          </template>
        ...
        <UCard :ui="{ body: 'p-4' }" class="shadow-sm border border-gray-200 h-full">
          <template #header>
            <div class="flex justify-between items-center">
              <h3 class="text-lg font-bold text-gray-900 flex items-center gap-2">
                ...
                Uploaded Periodic Self Assessment Documents
              </h3>
          ...
          <div v-else-if="store.regularImportedReports.length === 0" class="py-16 text-center space-y-4 rounded-lg border-2 border-dashed border-gray-100 bg-gray-50/50">
            ...
            <div class="max-w-md mx-auto">
              ...
              <p class="text-md text-gray-500 mt-1">Upload Periodic Self Assessment documents to add them to your records.</p>
            </div>
          </div>
