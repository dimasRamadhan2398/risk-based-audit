              ...
              <template v-if="store.selectedPlan">
                ...
                <div class="space-y-6 pt-6">
                  ...
                  <UCard class="border border-gray-200  rounded-lg p-6">
                    <template #header>
                      <h3 class="text-lg font-bold text-gray-800 ">Status Pelaksanaan</h3>
                    </template>
                  ...
                  <UCard class="border border-gray-200  rounded-lg p-6">
                    <template #header>
                      <h3 class="text-lg font-bold text-gray-800 ">1. Detil Aktivitas</h3>
                    </template>
                    
                    <div class="space-y-6">
                      <div class="flex items-center pb-4 border-b border-gray-100 ">
                        <span class="font-bold text-gray-700  w-48">Kode Aktivitas</span>
                      ...
                      >
                        ...
                        <div class="flex items-start">
                          <span class="font-bold text-gray-600  w-44 text-sm">Nama Aktivitas</span>
                          <span class="font-semibold text-gray-800  flex-1">{{ activity.name }}</span>
                        </div>

                        <div class="flex items-center">
                          <span class="font-bold text-gray-600  w-44 text-sm">Kategori</span>
                        ...
                        <div class="flex items-center">
                          <span class="font-bold text-gray-600  w-44 text-sm">Departemen</span>
                  ...
                  <UCard class="border border-gray-200  rounded-lg p-6">
                    ...
                    <div class="space-y-4">
                      <div class="flex items-center"><span class="font-bold text-gray-700  w-48">Tahun</span><span class="font-semibold text-gray-800 ">{{ store.selectedPlan.year }}</span></div>
                      <div class="flex items-center"><span class="font-bold text-gray-700  w-48">Distribusi Kuartal</span><span class="font-semibold text-gray-800 ">{{ store.selectedPlan.quarters?.map((q: any) => `[ ${q} ]`).join(' ') || '-' }}</span></div>
                      <div class="flex items-center"><span class="font-bold text-gray-700  w-48">Pelaksanaan Bulan</span><span class="font-semibold text-gray-800 ">{{ store.selectedPlan.selectedMonths?.slice().sort((a: number, b: number) => a - b).map((m: number) => `[ ${store.monthsList[m]} ]`).join(' ') || '-' }}</span></div>
                    </div>
                  </UCard>
                  ...
                  <UCard class="border border-gray-200  rounded-lg p-6">
                    ...
                    <div class="space-y-4">
                      ...
                      <div class="flex items-center"><span class="font-bold text-gray-700  w-48">Alokasi Waktu</span><span class="font-semibold text-gray-800 ">👥 {{ store.selectedPlan.auditorCount }} Auditor ⏱️ {{ store.selectedPlan.daysPerAuditor }} Hari Durasi</span></div>
                      ...
                      <div class="flex items-center"><span class="font-bold text-gray-700  w-48">Estimasi Kapasitas</span><span class="font-semibold text-gray-800 ">[🟢 Optimal (60-80%)] Total Load: 0.6% dari Kap Tahunan</span></div>
                    </div>
                  </UCard>
