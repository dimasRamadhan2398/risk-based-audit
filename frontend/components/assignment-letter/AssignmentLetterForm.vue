<template>
      ...
      <UModal v-model:open="store.isModalOpen" :dismissible="false" class="w-full sm:max-w-4xl">
        ...
        >
        <div class="relative bg-secondary-50 dark:bg-secondary-800 rounded-xl shadow-2xl flex flex-col max-h-[90vh]">
          <div class="flex justify-between items-center p-6 border-b border-gray-100 dark:border-gray-800 bg-secondary-50 dark:bg-secondary-800/50">
          ...
          <div class="p-6 border-t border-gray-100 dark:border-gray-800 bg-secondary-50 dark:bg-secondary-800/50 flex justify-end items-center gap-4">
